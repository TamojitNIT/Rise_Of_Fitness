...
<li class="nav-item"><a href="outsiderquery.php" class="nav-link bg-dark text-white" style="border-radius:10px;">Outsider_Query</a></li> 
...
echo'<div class="card-body text-white">Feedback:'.$row['question'].'</div>';
...
{
echo'<script>location.href="outsiderquery.php"</script>';    
}
else
{
