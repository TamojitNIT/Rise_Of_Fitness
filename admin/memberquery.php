...
<li class="nav-item"><a href="memberquery.php" class="nav-link bg-dark text-white" style="border-radius:10px;">Member_Query</a></li> 
...
echo'<div class="card-header bg-secondary text-white">slno:'.$row['slno'].'</div>';    
echo'<div class="card-header bg-secondary text-white">email:'.$row['email'].'</div>';
echo'<div class="card-body text-white">Feedback:'.$row['query'].'</div>';
