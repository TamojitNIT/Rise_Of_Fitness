...
{
if(($_REQUEST['name']=="")||($_REQUEST['feedback']==""))
{
...
$sql="INSERT INTO feedback(email,name,feedback,image)VALUES('$email','$name','$feedback','$img')";
...
<div class="col-sm-10"  style="background-image: url(../images/feedback.jpg);
background-repeat:no-repeat; background-position:center center; background-size:cover; height:100vh;">
<div class="row">
<div class="col-sm-5 offset-sm-3">
<h2 class="text-center text-white">Please Give Us Your FeedBack</h2>
<form action="" style="background-color: rgb(0,0,0,0.1);" method="post">
<div class="from-group">
<div class="text-danger text-center">
<lable for="Name">Name</lable>    
</div>
<input type="Name" value="<?php echo $name;?>" readonly class="form-control" name="name">
<small class="font-italic text-info">We Will Never Shear Your Personal Details</small> 
</div>    
<div class="form-group">
<div class="text-danger text-center">
<lable for="Feedback">Feedback</lable>
<textarea name="feedback" class="form-control" style="height:100px;" id="" cols="30" rows="10"></textarea>
<small class="font-italic text-info">Write Your Feedback Within 300 words</small>     
</div>    
</div>
<input type="submit" value="Send" name="sub" class="text-white btn btn-dark" style="border-color: firebrick; border-bottom-width: thick; margin-left:220px;">
</form>
