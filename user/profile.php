...
{
echo'<script>window.alert("Name_Updated")</script>';
}
else
{
...
<div class="col-sm-10"  style="background-image: url(../images/userprofile.jpg);
...
<div class="text-white"><h2 class="text-center">Your_Profile</h2></div>
...
<div class="form-group">
<i class="fa fa-user mr-2"></i>
<div class="text-danger"><label for="Name">Name</label></div>
<input type="text" class="form-control" value="<?php echo $name; ?>" name="name">   
<small class="font-italic text-info">We Will Never Shear Your Personal Details</small>  
</div>
<input type="submit" class="text-white btn btn-dark" style="border-color: firebrick; border-bottom-width: thick;  margin-left:150px;" value="Update" name="update">
